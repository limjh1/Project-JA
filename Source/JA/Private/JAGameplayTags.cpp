...
namespace JAGameplayTags
{
	...
	UE_DEFINE_GAMEPLAY_TAG(Player_Ability_Unquip_Axe, "Player.Ability.Unequip.Axe");
	...
	UE_DEFINE_GAMEPLAY_TAG(Player_SpecialWeaponAbility_Light, "Player.SpecialWeaponAbility.Light");
	UE_DEFINE_GAMEPLAY_TAG(Player_SpecialWeaponAbility_Heavy, "Player.SpecialWeaponAbility.Heavy");
